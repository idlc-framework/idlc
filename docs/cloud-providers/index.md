...
|:---------|:-------|:------------|
| [AWS]({{ site.baseurl }}/cloud-providers/aws/) | Reference implementation | Full module library with production examples |
| [Azure]({{ site.baseurl }}/cloud-providers/azure/) | Framework ready | Patterns defined, modules in development |
| [GCP]({{ site.baseurl }}/cloud-providers/gcp/) | Framework ready | Patterns defined, modules in development |
