...
- Deep dive into [Modules]({{ site.baseurl }}/concepts/modules/), [Solutions]({{ site.baseurl }}/concepts/solutions/), and [Deployments]({{ site.baseurl }}/concepts/deployments/)
- Explore the [8 Phases]({{ site.baseurl }}/phases/) in detail
